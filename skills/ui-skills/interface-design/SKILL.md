---
name: ui-skills-interface-design
description: >-
  Thin wrapper for vendored ui-skills/interface-design. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/ui-skills/interface-design/SKILL.md`
