---
name: next-next-cache-components-optimizer
description: >-
  Thin wrapper for vendored next/next-cache-components-optimizer. Apply WRAPPER-ESSENTIALS first;
  then execute the full upstream skill. Our essentials win on conflict.
---

# next/next-cache-components-optimizer
...
2. Read and execute **in full** the vendored skill at:
   `vendor/nextjs-skills/skills/next-cache-components-optimizer/SKILL.md`
