---
name: next-next-partial-prefetching-optimizer
description: >-
  Thin wrapper for vendored next/next-partial-prefetching-optimizer. Apply WRAPPER-ESSENTIALS first;
  then execute the full upstream skill. Our essentials win on conflict.
---

# next/next-partial-prefetching-optimizer
...
2. Read and execute **in full** the vendored skill at:
   `vendor/nextjs-skills/skills/next-partial-prefetching-optimizer/SKILL.md`
