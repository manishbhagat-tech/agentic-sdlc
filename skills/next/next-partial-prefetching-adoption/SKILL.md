---
name: next-next-partial-prefetching-adoption
description: >-
  Thin wrapper for vendored next/next-partial-prefetching-adoption. Apply WRAPPER-ESSENTIALS first;
  then execute the full upstream skill. Our essentials win on conflict.
---

# next/next-partial-prefetching-adoption
...
2. Read and execute **in full** the vendored skill at:
   `vendor/nextjs-skills/skills/next-partial-prefetching-adoption/SKILL.md`
