---
name: next-next-cache-components-adoption
description: >-
  Thin wrapper for vendored next/next-cache-components-adoption. Apply WRAPPER-ESSENTIALS first;
  then execute the full upstream skill. Our essentials win on conflict.
---

# next/next-cache-components-adoption
...
2. Read and execute **in full** the vendored skill at:
   `vendor/nextjs-skills/skills/next-cache-components-adoption/SKILL.md`
