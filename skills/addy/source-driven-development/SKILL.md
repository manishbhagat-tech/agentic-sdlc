...
description: >-
  Thin wrapper for vendored addy/source-driven-development. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/addy-agent-skills/skills/source-driven-development/SKILL.md`
