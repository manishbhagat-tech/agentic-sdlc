...
description: >-
  Thin wrapper for vendored addy/git-workflow-and-versioning. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/addy-agent-skills/skills/git-workflow-and-versioning/SKILL.md`
