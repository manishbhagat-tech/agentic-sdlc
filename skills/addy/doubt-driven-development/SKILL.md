...
description: >-
  Thin wrapper for vendored addy/doubt-driven-development. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/addy-agent-skills/skills/doubt-driven-development/SKILL.md`
