...
description: >-
  Thin wrapper for vendored addy/observability-and-instrumentation. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/addy-agent-skills/skills/observability-and-instrumentation/SKILL.md`
