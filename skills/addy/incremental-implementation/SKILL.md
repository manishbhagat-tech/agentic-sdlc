...
description: >-
  Thin wrapper for vendored addy/incremental-implementation. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/addy-agent-skills/skills/incremental-implementation/SKILL.md`
