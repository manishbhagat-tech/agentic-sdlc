...
description: >-
  Thin wrapper for vendored addy/performance-optimization. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/addy-agent-skills/skills/performance-optimization/SKILL.md`
