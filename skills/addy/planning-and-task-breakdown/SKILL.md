...
description: >-
  Thin wrapper for vendored addy/planning-and-task-breakdown. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/addy-agent-skills/skills/planning-and-task-breakdown/SKILL.md`
