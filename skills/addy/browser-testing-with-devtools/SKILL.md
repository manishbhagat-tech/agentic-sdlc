...
description: >-
  Thin wrapper for vendored addy/browser-testing-with-devtools. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/addy-agent-skills/skills/browser-testing-with-devtools/SKILL.md`
