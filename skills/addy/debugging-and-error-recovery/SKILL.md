...
description: >-
  Thin wrapper for vendored addy/debugging-and-error-recovery. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/addy-agent-skills/skills/debugging-and-error-recovery/SKILL.md`
