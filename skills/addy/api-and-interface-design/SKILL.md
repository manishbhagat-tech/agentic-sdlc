...
description: >-
  Thin wrapper for vendored addy/api-and-interface-design. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/addy-agent-skills/skills/api-and-interface-design/SKILL.md`
