---
name: sivalabs-apply-renovate-prs
description: >-
  Thin wrapper for vendored sivalabs/apply-renovate-prs. Apply WRAPPER-ESSENTIALS first;
  then execute the full upstream skill. Our essentials win on conflict.
---

# sivalabs/apply-renovate-prs
...
2. Read and execute **in full** the vendored skill at:
   `vendor/sivalabs-agent-skills/skills/apply-renovate-prs/SKILL.md`
