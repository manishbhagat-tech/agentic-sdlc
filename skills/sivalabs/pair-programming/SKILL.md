---
name: sivalabs-pair-programming
description: >-
  Thin wrapper for vendored sivalabs/pair-programming. Apply WRAPPER-ESSENTIALS first;
  then execute the full upstream skill. Our essentials win on conflict.
---

# sivalabs/pair-programming
...
2. Read and execute **in full** the vendored skill at:
   `vendor/sivalabs-agent-skills/skills/pair-programming/SKILL.md`
