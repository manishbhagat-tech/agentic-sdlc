---
name: sivalabs-spring-boot
description: >-
  Thin wrapper for vendored sivalabs/spring-boot. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/sivalabs-agent-skills/skills/spring-boot/SKILL.md`
