---
name: sivalabs-java-code-review
description: >-
  Thin wrapper for vendored sivalabs/java-code-review. Apply WRAPPER-ESSENTIALS first;
  then execute the full upstream skill. Our essentials win on conflict.
---

# sivalabs/java-code-review
...
2. Read and execute **in full** the vendored skill at:
   `vendor/sivalabs-agent-skills/skills/java-code-review/SKILL.md`
