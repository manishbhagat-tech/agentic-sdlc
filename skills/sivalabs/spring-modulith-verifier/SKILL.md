---
name: sivalabs-spring-modulith-verifier
description: >-
  Thin wrapper for vendored sivalabs/spring-modulith-verifier. Apply WRAPPER-ESSENTIALS first;
  then execute the full upstream skill. Our essentials win on conflict.
---

# sivalabs/spring-modulith-verifier
...
2. Read and execute **in full** the vendored skill at:
   `vendor/sivalabs-agent-skills/skills/spring-modulith-verifier/SKILL.md`
