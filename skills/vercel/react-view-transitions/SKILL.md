...
description: >-
  Thin wrapper for vendored vercel/react-view-transitions. Apply WRAPPER-ESSENTIALS first;
...
2. Read and execute **in full** the vendored skill at:
   `vendor/vercel-agent-skills/skills/react-view-transitions/SKILL.md`
