---
name: addy-agents-code-reviewer
description: >-
  Thin persona wrapper for vendored Addy agent `code-reviewer`. Apply WRAPPER-ESSENTIALS
  first; adopt perspective + output format from the vendor persona file.
---

# addy-agents/code-reviewer
...
2. Read and adopt the vendored persona at:
   `vendor/addy-agent-skills/agents/code-reviewer.md`
